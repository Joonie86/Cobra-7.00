...
SprxPatch emulator_api_patches[] =
{
	...
	// Drm patches
	{ dex_psp_drm_patch5, MAKE_JUMP_VALUE(dex_psp_drm_patch5, dex_psp_drm_patch6), &condition_psp_iso },
	{ dex_psp_drm_patch7, LI(R6, 0), &condition_psp_iso },
	{ dex_psp_drm_patch8, LI(R7, 0), &condition_psp_iso },
	{ dex_psp_drm_patch9, NOP, &condition_psp_iso },
	{ dex_psp_drm_patch11, LI(R6, 0), &condition_psp_iso },
	{ dex_psp_drm_patch12, LI(R7, 0), &condition_psp_iso },
	{ cex_psp_drm_patch5, MAKE_JUMP_VALUE(cex_psp_drm_patch5, cex_psp_drm_patch6), &condition_psp_iso },
	{ cex_psp_drm_patch7, LI(R6, 0), &condition_psp_iso },
	{ cex_psp_drm_patch8, LI(R7, 0), &condition_psp_iso },
	{ cex_psp_drm_patch9, NOP, &condition_psp_iso },
	{ cex_psp_drm_patch11, LI(R6, 0), &condition_psp_iso },
	{ cex_psp_drm_patch12, LI(R7, 0), &condition_psp_iso },
	// product id
