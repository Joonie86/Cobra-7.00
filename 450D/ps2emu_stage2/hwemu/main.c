...
#if defined(FIRMWARE_3_41) || defined(FIRMWARE_3_55) || defined(FIRMWARE_4_30)

#define AUTH_OFFSET		0x2058C
#define DISC_SIZE_OFFSET	0x255A0
#define DISC_TYPE_OFFSET	0x25290

#elif defined(FIRMWARE_4_46) || defined(FIRMWARE_4_50DEX)

#define AUTH_OFFSET		0x20680
#define DISC_SIZE_OFFSET	0x25694
#define DISC_TYPE_OFFSET	0x25384

#endif

#if defined(FIRMWARE_3_41) || defined(FIRMWARE_3_55) || defined(FIRMWARE_4_30) || defined(FIRMWARE_4_46) || defined(FIRMWARE_4_50DEX)
