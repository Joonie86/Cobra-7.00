...
#define VSH_HASH			0xa03f9441002e411a //done

#define BASIC_PLUGINS_HASH		0xb5989f8a0001fefa //done					

#define NAS_PLUGIN_HASH			0xacf4af2b00027398 //done 

#define EXPLORE_PLUGIN_HASH		0xacf4af2b000ecdf3 //done

#define EXPLORE_CATEGORY_GAME_HASH	0x9cb333060005707b //done

#define BDP_DISC_CHECK_PLUGIN_HASH	0xb8b7a5f9000031a0 //done
#define PS1_EMU_HASH			0x7a6cb94f0009a9f2 //done

#define PS1_NETEMU_HASH			0x7a3017f2000bdac7 //done

#define GAME_EXT_PLUGIN_HASH		0xe274af7b0001e2ba //done

#define PSP_EMULATOR_HASH		0x7be641f500023793 //done
#define EMULATOR_API_HASH		0xa9f5bc7a0001baac //done
#define PEMUCORELIB_HASH		0xf349a563000c0d00 //done
#define EMULATOR_DRM_HASH		0xa324dc4a0000539c //done
#define EMULATOR_DRM_DATA_HASH		0x1d8d2da00001b6e4 //done
#define LIBSYSUTIL_SAVEDATA_PSP_HASH	0x57bbc04800003207 //done
#define LIBFS_EXTERNAL_HASH		0x5bc7bce800006477 //done

/* vsh */
#define vsh_text_size			0x6C0000 /* memsz of first program header aligned to 0x10000 */ //done
#define elf1_func1 			0x5F14E4 //done
#define elf1_func1_offset 		0x00
#define elf1_func2 			0x24ABB0 //done
#define elf1_func2_offset 		0x14
#define game_update_offset		0x275608 //done
#define ps2tonet_patch			0xCA18C //done
#define ps2tonet_size_patch		0xCA180 //done
#define psp_drm_patch1			0x247E78 //done
#define psp_drm_patch2			0x248918 //done
#define psp_drm_patch3			0x248554 //done??
#define psp_drm_patch4			0x248D60 //done
#define psp_drm_patchA			0x247F94 //done
#define psp_drm_patchB			0x248834 //done
#define psp_drm_patchC			0x2479CC //done
#define psp_drm_patchD			0x247F7C //done
#define psp_drm_patchE			0x247F80 //done
#define psp_drm_patchF			0x24894C //done
#define revision_offset			0x6601D0 //done
#define revision_offset2		0x710F44 /* In data section */ //??
#define spoof_version_patch		0xBDCC0 //done??
#define psn_spoof_version_patch		0x1AA0F0 //done
#define vmode_patch_offset		0x449B6C //done

/* basic_plugins */
#define ps1emu_type_check_offset	0x200C8 //done
#define pspemu_path_offset		0x4B688 //done
#define psptrans_path_offset		0x4C2E0 //done

/* nas_plugin */
#define elf2_func1 			0x2EEE4 
#define elf2_func1_offset		0x0 
#define geohot_pkg_offset		0x3264 

/* explore_plugin */
#define app_home_offset			0x2515B0 //done
#define ps2_nonbw_offset		0xDDD18 //done

/* explore_category_game */
#define ps2_nonbw_offset2		0x682F0 //done
#define unk_patch_offset1		0x546C /* unknown patch from E3 cfw */ //done
#define unk_patch_offset2		0x5490 /* unknown patch from E3 cfw */ //done

/* bdp_disc_check_plugin */
#define dvd_video_region_check_offset	0x152C //done

/* ps1_emu */
#define ps1_emu_get_region_offset	0x3E74	//done

/* ps1_netemu */
#define ps1_netemu_get_region_offset	0xA440C //done

/* game_ext_plugin */
#define sfo_check_offset		0x238A0 //done
#define ps2_nonbw_offset3		0x16B04 //done
#define ps_region_error_offset		0x6958 //done

/* psp_emulator */
#define psp_set_psp_mode_offset		0x1C18 //done

/* emulator_api */
#define psp_read			0x10198 //done
#define psp_read_header			0x1111C //done
#define psp_drm_patch5			0x10F40 //done
#define psp_drm_patch6			0x10F70 //done
#define psp_drm_patch7			0x10F88 //done
#define psp_drm_patch8			0x10F8C //done
#define psp_drm_patch9			0x110CC //done
#define psp_drm_patch11			0x110D0 //done
#define psp_drm_patch12			0x110E0 //done
#define psp_product_id_patch1		0x111E0 //done
#define psp_product_id_patch3		0x114B8 //done
#define umd_mutex_offset		(0x64480+0x38C) //done

/* pemucorelib */
#define psp_eboot_dec_patch		0x5E6BC //done
#define psp_prx_patch			0x577D8 //done
#define psp_savedata_bind_patch1	0x7A4BC //done
#define psp_savedata_bind_patch2	0x7A514 //done
#define psp_savedata_bind_patch3	0x7A030 //done
#define psp_extra_savedata_patch	0x8753C //done
#define psp_prometheus_patch		0x12EA28 //done
#define prx_patch_call_lr		0x5892C //done

/* emulator_drm */
#define psp_drm_tag_overwrite		0x4C68 //done
#define psp_drm_key_overwrite		(0x27580-0xBE80) //done

/* libsysutil_savedata_psp */
#define psp_savedata_patch1		0x46D4 //done
#define psp_savedata_patch2		0x46AC //done
#define psp_savedata_patch3		0x450C //done
#define psp_savedata_patch4		0x4544 //done
#define psp_savedata_patch5		0x4558 //done
#define psp_savedata_patch6		0x46C0 //done

/* libfs (external */
#define aio_copy_root_offset		0xD658 //done
