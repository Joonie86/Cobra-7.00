...
int main(int argc, char *argv[])
{
	...
	command3("scetool.exe", "--decrypt", self_input, "temp.elf");	
	...
	command15("scetool.exe", "-v", "--sce-type=SELF", "--compress-data=TRUE", "--compress-data=TRUE", "--skip-sections=FALSE", 
		 "--self-auth-id=1050000003000001", "--self-add-shdrs=TRUE", "--self-vendor-id=05000002", "--self-type=LV2", 
	         "--self-fw-version=0004005300000000", "--key-revision=0", "--self-app-version=0004005300000000", "--encrypt", "temp.elf", self_output);
