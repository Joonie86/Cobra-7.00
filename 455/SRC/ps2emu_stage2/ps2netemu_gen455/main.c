...
#define PS2EMU
#define PS2NETEMU
#define FIRMWARE_4_55

#include "../../ps2emu/include/ps2emu/symbols.h"

#define read_iso_size_call	0x135E70 //
#define fstat_iso_call		0x135D64 // 
#define open_iso_call1		0x135D28 // 
#define open_iso_call2		0x136DAC //
#define savedata_patch		0x11AEF4 //

#define ADDITIONAL_CODE_SIZE		0xC00 //
#define ADDITIONAL_DATA_SIZE		0x1000 //

#define CODE_SECTION_ADDR		0x28f640 //
...
#define SH_ADDR			0x2922D8 // /* look in self, not in elf */
