...
#elif defined(FIRMWARE_4_55) //4.55

#define VSH_HASH			0xa002301e002e17e3 //
#define VSH_ROG_HASH			0xa002301e002e17e3 // /* 1.00, 1.01. Same for rebug vsh.self.cexsp */
#define VSH_HAB_HASH			0xa002301e002e17e3 // /* 1.13. Same for arc A01 */
#define VSH_FER_HASH			0xa002301e002e17e3 // /* v3 */
...
#define EXPLORE_PLUGIN_HASH		0xacf4af2b000ec3a7 //
#define EXPLORE_PLUGIN_ROG_HASH		0xacf4af2b000ec3a7 //  Same for hab, fer, arc */
...
#define PS1_EMU_HASH			0x7a6cb94f0009a9f4 //
#define PS1_NETEMU_HASH			0x7a301072000bdadc //
...
#define elf1_func1 			0x5EAAC0 //
#define elf1_func1_offset 		0x00 //
#define elf1_func2 			0x243450 //
#define elf1_func2_offset 		0x14 //
#define game_update_offset		0x26EEAC //FIXED!
...
#define revision_offset			0x6590D0 //FIXED!!
#define revision_offset2		0x7005A8 // /* In data section */
#define spoof_version_patch		0xB8E60 //
#define psn_spoof_version_patch		0x1A2848 //
#define vmode_patch_offset		0x442FD8 //FIXED!!
