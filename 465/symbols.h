...
#elif defined(FIRMWARE_4_46) //4.65
...
#define cellFsUtime_symbol				0x2A1084 //FIXED!!
#define cellFsUnlink_internal_symbol			0x19C4B4 //

#define cellFsUtilMount_symbol				0x29F908 //
#define cellFsUtilUmount_symbol				0x29F8BC //fixed AGAIN!
...
#define prx_get_module_id_by_name_symbol		0x86F64 //FIXED!!
...
#define user_thread_prio_patch				0x203FC //fixed
...
#define decrypt_rtoc_entry_2 				-0x66A0 //fixed this fucking bitch!wasted alot of time!!!!
#define decrypter_data_entry				-0x7F10 //
...
#define patch_func2_offset 				0x2C //
#define patch_func8 					0x5640C //lv2open update patch //
#define patch_func8_offset1 				0xA4 //lv2open update patch //
#define patch_func8_offset2 				0x208 //lv2open update patch //
